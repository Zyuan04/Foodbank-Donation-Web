...
function ListFoodbanks($conn)
{
    ...
    $sql = "SELECT FoodbankID, PictureName, FoodbankName, FoodbankLocation FROM FoodbankInfo ORDER BY FoodbankID";
...
<div>
    ...
    <div class="topnav">
        ...
        <a href="Account-page.php"><?php echo $_SESSION['userloggedin'] ? "Logged in as " . $_SESSION['userloggedin'] : "Account"; ?></a>
